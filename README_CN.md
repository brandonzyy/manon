...
**第二层 — 开发技能**（工作流）
五个技能覆盖完整开发生命周期 — 需求、代码质量、测试和验证。每个技能都依赖图谱，确保决策基于代码事实而非 LLM 想象。
...
分析 OpenClaw 项目（2,100 文件）。完整报告：[`docs/MANON_VS_NATIVE_COMPARISON_EN.md`](docs/MANON_VS_NATIVE_COMPARISON_EN.md)
...
20 个真实查询。完整报告：[`docs/manon-query-tools-evaluation-en.md`](docs/manon-query-tools-evaluation-en.md)
