"""Tests for mcp/_sync.py — sync progress, state tracking."""
import json
import pytest
from pathlib import Path
from unittest.mock import MagicMock, patch

from mcp._sync import (
...
class TestSyncProgress:
    def test_write_and_read(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("mcp._sync._SYNC_PROGRESS_FILE", progress_file)
    ...
    def test_read_missing(self, tmp_path, monkeypatch):
        monkeypatch.setattr("mcp._sync._SYNC_PROGRESS_FILE", tmp_path / "nope.json")
